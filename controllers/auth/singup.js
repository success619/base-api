...
signup.post("/create_account", async (req, res) => {
    const { firstName, lastName, sex, email, phoneNumber, country, password, school, department, } = req.body; //Information provided by the new user is brought in to server with req.body;
